...
include '../config/controller.php' ; 
 ...
 $matkul = select("SELECT * FROM matkul WHERE id_matkul=$id_matkul")[0];
}
...
if (isset($_POST['ubah'])) {
    if (update_matkul($_POST) > 0) {
        ...
        echo "<script>
                alert('Data matkul gagal diubah');
                document.location.href = 'matkul.php';
            </script>";
    }
}
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Mata Kuliah
                        </li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Edit Mata Kuliah</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
