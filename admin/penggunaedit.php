...
if (isset($_GET['id'])) {
  ...
  $pengguna = select("SELECT * FROM user WHERE id=$id")[0];
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="./xirpl/kaist/admin/dashboard.php">
                        <div
    ...
    <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Pengguna</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Edit Pengguna</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
        ...
        <div class="container-fluid">
            <div class="container mt-5">
                <h3>Edit Data Pengguna <?php echo $pengguna['id'] ?></h3>
                <form action="" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="username"
                            value="<?= htmlspecialchars($pengguna['username'], ENT_QUOTES, 'UTF-8'); ?>" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="password" class="form-label">Password</label>
                        <input type="password" class="form-control" id="password" name="password"
                            placeholder="Leave blank to keep current password" data-toggle="tooltip"
                            data-placement="right" title="Biarkan Kosong Jika Tidak Merubah Password">
                    </div>

                    <div class="form-group mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama"
                            value="<?= htmlspecialchars($pengguna['nama'], ENT_QUOTES, 'UTF-8'); ?>" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="level" class="form-label">Level</label>
                        <select class="form-control" id="level" name="level" required>
                            <option value="" disabled <?= empty($pengguna['level']) ? 'selected' : ''; ?>>Pilih
                                Level</option>
                            <option value="Admin" <?= ($pengguna['level'] === 'admin') ? 'selected' : ''; ?>>
                                Admin</option>
                            <option value="Operator" <?= ($pengguna['level'] === 'operator') ? 'selected' : ''; ?>>
                                Operator</option>
                            <option value="Guru" <?= ($pengguna['level'] === 'guru') ? 'selected' : ''; ?>>Guru
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            <option value="1" <?= ($pengguna['status'] == 1) ? 'selected' : ''; ?>>Aktif
                            </option>
                            <option value="2" <?= ($pengguna['status'] == 2) ? 'selected' : ''; ?>>Non Aktif
                            </option>
                        </select>
                    </div>
